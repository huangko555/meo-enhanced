...
// These reference budgets are calibrated by the Phase I production benchmark.
...
/** Pure text assessment shared by Host startup policy and the Editor work budget. */
